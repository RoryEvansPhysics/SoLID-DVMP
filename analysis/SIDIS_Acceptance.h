...
class SIDIS_Acceptance{
    ...
    public:
        ...
        void Init(){/*{{{*/
            //CLEO
            TString ele_filename = "./acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_negative_output.root";
            TString pos_filename = "./acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_positive_output.root";
            TString neu_filename = "./acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_neutral_output.root";
            TString pip_filename = "./acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_positive_output.root";
            TString pim_filename = "./acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_negative_output.root";
